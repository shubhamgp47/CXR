    ...
    dict(
        ...
        transforms=[
            ...
            [
                dict(
                    type='RandomChoiceResize',
                    scales=[(800, 4200)],  # Can keep this if needed
                    keep_ratio=True),
...
val_dataloader = dict(
    dataset=dict(
        ...
        #ann_file=data_root+'fixed_annotation_file.json'))

val_evaluator = dict(ann_file=data_root + 'test_abn_vindr_16k_orig.json', classwise=True)
#val_evaluator = dict(ann_file=data_root + 'fixed_annotation_file.json', classwise=True)
...
load_from = 'https://huggingface.co/camenduru/SMPLer-X/resolve/main/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
