...
'''metainfo = {
    'classes': ('background', 'lesion', 'consolidation', 'device', 'atelectasis', 'pleuraleffusion', 'intersabnormality', 'pneumothorax', 'calcification', 'fracturedribsbones', 'hilarenlargment', 'scoliosis', 'eventration', 'pneumoperitoneum', 'hernia', 'emphysema', 'aorticdilatation', 'thickening', 'trachealdev', 'subemphysema', 'degenerativechanges', 'sternalwire', 'ttortuosity', 'tcalcification', 'abngas','cardiomegaly'),
    'palette': [
            (220, 120, 60), (0, 11, 255), (0, 0, 142), (0, 0, 230), (106, 0, 228), (100, 170, 30), (139, 0, 139), (255, 0, 0), 
            (255, 20, 147), (240, 128, 128), (255, 192, 203), (250, 128, 114), (255, 105, 180), (255, 99, 71), (255, 69, 0), (255, 69, 0) ,(240, 128, 128),(240, 128, 128),(240, 128, 128),(205, 92, 92), (255, 0, 255), (128, 0, 0), (255, 50, 0), (128, 0, 128), (139, 69, 19), (0, 128, 0), ]
}
'''
metainfo = {
    'classes': (
...
train_pipeline = [
    ...
    dict(type='Resize', scale=(640, 640), keep_ratio=False),  # Explicitly resize to 640x640
    dict(
        type='PackDetInputs',
...
load_from ='https://download.openmmlab.com/mmdetection/v3.0/rtmdet/rtmdet_l_swin_b_coco.pth'
